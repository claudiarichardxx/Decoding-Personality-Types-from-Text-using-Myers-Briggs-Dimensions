...
class Pipeline:
    ...
    def pipeline(self, text):
        ...
        self.encoded, labels = pred.tokenizer(text, return_attention_mask=True, return_tensors="pt"), pred.predict_labels(text)
        htmls = []
        ...
        for i in range(0,4):
            ...
            if(self.checkThreshold(self, attributions, label = int(labels[i]))):
